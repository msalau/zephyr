 ...
 *
 * The lock ensures that no new requests are handled while the inetraface is locked.
 * May be used to ensure atomic update of register values in server role and
 * prevent a client from sending new request.
 *
 * @param iface   Modbus interface index
 ...
 * @retval -ENOTSUP The feature is disabled
